...
<body>
  ...
  <section class="text-gray-700 body-font relative">
    <form form action="https://formspree.io/f/myybojog" method="POST">
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2">
        <div class="p-2 w-1/2">
          <input class="w-full bg-gray-100 rounded border border-gray-400 focus:outline-none focus:border-indigo-500 text-base px-4 py-2" placeholder="Name" type="text" name="name">
        </div>
        <div class="p-2 w-1/2">
        ...
        <div class="p-2 w-full">
          <textarea class="w-full bg-gray-100 rounded border border-gray-400 focus:outline-none h-48 focus:border-indigo-500 text-base px-4 py-2 resize-none block" placeholder="Message" type="message" name="User message"></textarea>
        </div>
        <input type="submit" class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" data-toggle="modal" data-target="#exampleModal" value="Submit" name="Submit">
